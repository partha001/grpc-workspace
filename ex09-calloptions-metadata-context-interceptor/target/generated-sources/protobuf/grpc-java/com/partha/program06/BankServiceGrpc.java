...
@javax.annotation.Generated(
    ...
    comments = "Source: program06/bank-service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class BankServiceGrpc {

  private BankServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "program06.BankService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.partha.program06.BalanceCheckRequest,
      com.partha.program06.AccountBalance> getGetAccountBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBalance",
      requestType = com.partha.program06.BalanceCheckRequest.class,
      responseType = com.partha.program06.AccountBalance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.partha.program06.BalanceCheckRequest,
      com.partha.program06.AccountBalance> getGetAccountBalanceMethod() {
    io.grpc.MethodDescriptor<com.partha.program06.BalanceCheckRequest, com.partha.program06.AccountBalance> getGetAccountBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetAccountBalanceMethod = BankServiceGrpc.getGetAccountBalanceMethod) == null) {
          BankServiceGrpc.getGetAccountBalanceMethod = getGetAccountBalanceMethod =
              io.grpc.MethodDescriptor.<com.partha.program06.BalanceCheckRequest, com.partha.program06.AccountBalance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.partha.program06.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.partha.program06.AccountBalance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.partha.program06.WithdrawRequest,
      com.partha.program06.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Withdraw",
      requestType = com.partha.program06.WithdrawRequest.class,
      responseType = com.partha.program06.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.partha.program06.WithdrawRequest,
      com.partha.program06.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.partha.program06.WithdrawRequest, com.partha.program06.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.partha.program06.WithdrawRequest, com.partha.program06.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.partha.program06.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.partha.program06.Money.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getAccountBalance(com.partha.program06.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.partha.program06.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    default void withdraw(com.partha.program06.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.partha.program06.Money> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getAccountBalance(com.partha.program06.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.partha.program06.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.partha.program06.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.partha.program06.Money> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.partha.program06.AccountBalance getAccountBalance(com.partha.program06.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.partha.program06.Money> withdraw(
        com.partha.program06.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.partha.program06.AccountBalance> getAccountBalance(
        com.partha.program06.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BALANCE:
          serviceImpl.getAccountBalance((com.partha.program06.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.partha.program06.AccountBalance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.partha.program06.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.partha.program06.Money>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.partha.program06.BalanceCheckRequest,
              com.partha.program06.AccountBalance>(
                service, METHODID_GET_ACCOUNT_BALANCE)))
        .addMethod(
          getWithdrawMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.partha.program06.WithdrawRequest,
              com.partha.program06.Money>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.partha.program06.BankServiceOuterClass.getDescriptor();
    }
